...
export const tools: Tool[] = [
  ...
  { slug: 'name-to-japanese', title: 'Name to Japanese Converter', shortTitle: 'Name to Japanese', description: 'Convert English and Chinese names to Japanese katakana and hiragana instantly. See how your name sounds in Japanese with accurate phonetic transcription.', icon: 'fa-language', category: 'utility', color: '#db2777' },
